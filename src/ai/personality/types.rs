...
impl PersonalityAiState {
    ...
    pub fn set_personality(&mut self, unit_id: u32, profile: PersonalityProfile) {
        self.personality_by_unit.insert(unit_id, profile);
    }
...
pub fn apply_personality_overrides(
    state: &SimState,
