...
use super::features::{is_healer, unit_dps};
...
fn rich_entity_features(
    ...
    let heal_cd_pct = if unit.heal_cooldown_ms > 0 {
        unit.heal_cooldown_remaining_ms as f32 / unit.heal_cooldown_ms as f32
    } else { 0.0 };

    let control_cd_pct = if unit.control_cooldown_ms > 0 {
    ...
    [
        ...
        attack_cd_pct,
        // Ability (15-17)
        unit.ability_damage as f32 / 50.0,
        unit.ability_range / 10.0,
        ability_cd_pct,
        // Healing (18-20)
        unit.heal_amount as f32 / 50.0,
        unit.heal_range / 10.0,
        heal_cd_pct,
        // CC capability (21-23)
        unit.control_range / 10.0,
        unit.control_duration_ms as f32 / 2000.0,
        control_cd_pct,
        // Current state (24-27)
        is_casting,
        cast_remaining_norm,
